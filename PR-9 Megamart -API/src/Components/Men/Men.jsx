...
import { deleteMenAsync, filterMenData, getAllMenAsync } from '../Services/Action/Action';
...
const Men = () => {
  const { products } = useSelector(state => state); // Correct selector
